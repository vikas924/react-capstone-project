    ...
    builder.addCase(fetchanime.pending, (state) => ({
      ...
      .addCase(fetchanime.fulfilled, (state, action) => ({
        ...
        animelist: (Object.keys(action.payload.data).map((key) => ({
          ...
          synopsis: action.payload.data[key].synopsis,
          genres: action.payload.data[key].genres,
          trailer: action.payload.data[key].trailer,
          aired: action.payload.data[key].aired,
          rating: action.payload.data[key].rating,
          status: action.payload.data[key].status,
        }))),
