...
# 📖 [Anibook website] <a name="about-project"></a>

Anibook is a website made using react, redux. This website let use to check different anime and seach or check by different genres.
